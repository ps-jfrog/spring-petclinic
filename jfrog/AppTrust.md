...
```mermaid
graph TD
    %% Define main SDLC Stages using subgraphs
    ...
    REJECTED[["Blocked from<br/>Production Deployment"]]
    ...
    G2 -- "Fail" --> REJECTED
    G2 -.- G2_P
    JF_CR -.-|"Blocks unsafe downloads"| B_DEV
    ...
    %% Continuous Feedback
    F_E -.-|"Feedback loop to planning"| A_E
    F_E -.-|"Feedback loop to developer fix"| B
    F -.- FL
    FL -.- A

    %% Platform and evidence relationships
    JF_AR -.-|"Immutable evidence bundle"| G3
    JF_AR -.-|"Immutable evidence bundle"| G4
    JF_AR -.-|"Immutable evidence bundle"| T_B
    JF_XR -.-|"Scans"| JF_AR
